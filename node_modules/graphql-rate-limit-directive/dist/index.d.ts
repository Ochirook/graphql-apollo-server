...
export declare type RateLimitKeyGenerator<TContext> = (directiveArgs: RateLimitArgs, obj: unknown, args: {
    [key: string]: unknown;
}, context: TContext, info: GraphQLResolveInfo) => Promise<string> | string;
export declare type RateLimitPointsCalculator<TContext> = (directiveArgs: RateLimitArgs, obj: unknown, args: {
    [key: string]: unknown;
}, context: TContext, info: GraphQLResolveInfo) => Promise<number> | number;
export declare type RateLimitOnLimit<TContext> = (resource: RateLimiterRes, directiveArgs: RateLimitArgs, obj: unknown, args: {
    [key: string]: unknown;
 ...
 */
export declare function defaultKeyGenerator<TContext>(directiveArgs: RateLimitArgs, obj: unknown, args: {
    [key: string]: unknown;
 ...
 * @param info Holds field-specific information relevant to the current operation as well as the schema details.
 */
export declare function defaultPointsCalculator<TContext>(directiveArgs: RateLimitArgs, obj: unknown, args: {
    [key: string]: unknown;
 ...
 * @param info Holds field-specific information relevant to the current operation as well as the schema details.
 */
export declare function defaultOnLimit<TContext>(resource: RateLimiterRes, directiveArgs: RateLimitArgs, obj: unknown, args: {
    [key: string]: unknown;
}, context: TContext, info: GraphQLResolveInfo): unknown;
/**
 ...
 */
export declare function createRateLimitTypeDef(directiveName?: string): DocumentNode;
/**
